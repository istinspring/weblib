...
from weblib.text import find_number, find_float, drop_space, normalize_space
...
class TextTestCase(TestCase):
    ...
    def test_find_float(self):
        self.assertEqual(2.0, find_float('2'))
        self.assertEqual(2.0, find_float('2.0'))
        self.assertEqual('2.0', find_float('2.0', make_float=False))
        self.assertEqual(2.0, find_float('some text 2 some text'))
        self.assertEqual(2.0, find_float('some text 2.0 some text'))
    ...
    def test_normalize_space(self):
        ...
        self.assertEqual(u'тр_и_гла_за',
                         normalize_space(u' тр и гла' + '\t' + '\n' + u' за ', replace='_'))
        self.assertEqual(u'трABCиABCглаABCза',
                         normalize_space(u' тр и гла' + '\t' + '\n' + u' за ', replace='ABC'))
